...
/*   Updated: 2025/02/06 13:11:48 by hdrahm           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../cub3D_bonus.h"

void	draw_wall_line(t_base *game, double line_length, double x, int tex_x,
		int n)
{
	double		y;
	double		start_wall;
	...
	texture_pos = (start_wall - ((SCREEN_HEIGHT / 2) - (line_length / 2)))
		* texture_step;
	while (y < end_wall)
	{
		...
		color = *(unsigned int *)((char *)texture->data + (tex_y
					* texture->line_length + tex_x * (texture->bpp / 8)));
