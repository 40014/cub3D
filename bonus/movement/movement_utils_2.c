...
void update_new_position(t_player_info *player_infos, int sign, double speed, double angle)
{
    if (sign == 1)
    {
        player_infos->new_i = player_infos->i + cos(player_infos->rotation_angle + angle) * speed;
        player_infos->new_j = player_infos->j + sin(player_infos->rotation_angle + angle) * speed;
    }
    else
    {
        player_infos->new_i = player_infos->i - cos(player_infos->rotation_angle ) * speed;
        player_infos->new_j = player_infos->j - sin(player_infos->rotation_angle ) * speed;
    }
}
...
void update_position(t_player_info *player_infos, int sign, double speed, double angle)
{
    if (sign == 1)
    {
        player_infos->i = player_infos->i + cos(player_infos->rotation_angle + angle) * speed;
        player_infos->j = player_infos->j + sin(player_infos->rotation_angle + angle) * speed;
    }
    else
    {
        player_infos->i = player_infos->i - cos(player_infos->rotation_angle ) * speed;
        player_infos->j = player_infos->j - sin(player_infos->rotation_angle ) * speed;
    }
}